        ...
        if (kunde.getBekommtRabatt()) {
            ...
            for (Bestellposition bestellposition : this.positionen) {
                System.out.printf("%15s %15s %15.2f %15.2f %15d\n",
                        bestellposition.getWare().getNormalisierteWarennummer(), bestellposition.getWare().getBezeichnung(), bestellposition.getWare().getPreis(), Kundenrabatt.berechneRabattpreis(bestellposition.getWare().getPreis()), bestellposition.getMenge()
                );
            }
        } else {
            ...
            for (Bestellposition bestellposition : this.positionen) {
                System.out.printf("%15s %15s %15.2f %15d\n",
                        bestellposition.getWare().getNormalisierteWarennummer(), bestellposition.getWare().getBezeichnung(), bestellposition.getWare().getPreis(), bestellposition.getMenge()
                );
            }
        }
